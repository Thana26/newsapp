  ...
  render() {
    return (
      <div>
        ...
        <Navbar/> 
        <Routes>
          <Route exact path="/" element={<News key="general" pageSize={7} country="in" category="general"/>}></Route> 
          <Route exact path="/business" element={<News key="business" pageSize={7} country="in" category="business"/>}></Route> 
